...
export default function AuthLayout({
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-[linear-gradient(135deg,#E9FBF8_0%,#F7FFF8_52%,#FFFBEA_100%)] px-4 py-10">
      ...
      {/* 装飾は絶対配置なので、中身とフッターは relative を付けて上に重ねる。 */}
