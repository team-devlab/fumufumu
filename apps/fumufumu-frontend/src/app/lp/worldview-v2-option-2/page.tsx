    ...
    <div className="min-h-screen bg-[#F7F8F6] text-slate-800">
      ...
      <main>
        ...
        <section className="px-6 pb-24 lg:px-8">
          <div className="mx-auto max-w-6xl rounded-[36px] bg-gradient-to-r from-teal-600 to-emerald-500 px-8 py-12 text-white shadow-[0_24px_80px_rgba(13,148,136,0.30)] lg:px-12 lg:py-14">
            <div className="mx-auto max-w-4xl">
              <div className="inline-flex rounded-full bg-white/15 px-4 py-2 text-sm font-semibold text-white">
                Main CTA
              </div>
