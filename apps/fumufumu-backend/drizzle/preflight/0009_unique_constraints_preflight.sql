-- Preflight check for migration 0009 (0009_lying_surge.sql)
--
-- 0009 は以下の 3 つの UNIQUE INDEX を追加する:
...
-- あることを確認する。1 行でも返った場合は重複を解消してから 0009 を適用すること。
--
-- 実行例:
--   wrangler d1 execute DB --remote \
--     --config "$WRANGLER_D1_CONFIG" \
--     --file drizzle/preflight/0009_unique_constraints_preflight.sql
